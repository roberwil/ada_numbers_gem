...
class WordsToNumberConverterPtTest < Minitest::Test
  ...
  describe "PT :: To number - Unities are valid" do
    [
      [0, "Zero"],
      [1, "Um"],
      [2, "Dois"],
  ...
  describe "PT :: To number - Tens are valid" do
    [
      [10, "Dez"],
      [11, "Onze"],
      [12, "Doze"],
  ...
  describe "PT :: To number - Hundred are valid" do
    [
      [100, "Cem" ],
      [101, "Cento e Um" ],
      [111, "Cento e Onze" ],
  ...
  describe "PT :: To number - Thousands are valid" do
    [
      [1000, "Mil"],
      [1001, "Mil e Um"],
      [1011, "Mil e Onze"],
  ...
  describe "PT :: To number - Millions are valid" do
    [
      [1000000, "Um Milhão"],
  ...
  describe "PT :: To number - Thousand Millions are valid" do
    [
  ...
  describe "PT :: To number - Thousand Millions in short scale (billions) are valid" do
    [
  ...
  describe "PT :: To number - Billions are valid" do
    [
  ...
  describe "PT :: To number - Billions in short scale (trillions) are valid" do
    [
  ...
  describe "PT :: To number - Random integers are valid" do
    [
      [42, "Quarenta e Dois" ],
      [102, "Cento e Dois" ],
      [113, "Cento e Treze" ],
  ...
  describe "PT :: To number - Random decimals are valid" do
    [
